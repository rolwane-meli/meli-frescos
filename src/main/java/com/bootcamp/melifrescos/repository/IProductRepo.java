...
public interface IProductRepo extends JpaRepository<Product, Long> {
    ...
    @Query("select new  com.bootcamp.melifrescos.dto.PurchaseOrderResponse(b.productQuantity, b.price) from Product p inner join Batch b on(b.product.id=p.id) where b.id=:idBatch")
    Optional<PurchaseOrderResponse> findProductByBatchesById(@Param("idBatch") Long idBatch);
}
